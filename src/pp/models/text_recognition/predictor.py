...
from src.pp.utils.visualisation.fonts import (
    ARABIC_FONT,
    CYRILLIC_FONT,
    DEVANAGARI_FONT,
    EL_FONT,
...
from src.pp.models.text_recognition.processors import CTCLabelDecode, OCRReisizeNormImg, ToBatch
from src.pp.models.text_recognition.result import TextRecResult
