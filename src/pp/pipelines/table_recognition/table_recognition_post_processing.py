...
from src.pp.pipelines.utils.bbox_operations import convert_points_to_boxes
...
from src.pp.pipelines.table_recognition.result import SingleTableRecognitionResult
