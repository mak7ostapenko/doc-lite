...
from src.pp.pipelines.doc_preprocessor.result import DocPreprocessorResult
from src.pp.pipelines.layout_parsing.utils import get_sub_regions_ocr_res
from src.pp.pipelines.ocr.result import OCRResult
from src.pp.pipelines.table_recognition.result import SingleTableRecognitionResult, TableRecognitionResult
from src.pp.pipelines.table_recognition.table_recognition_post_processing import (
    get_table_recognition_res as get_table_recognition_res_e2e,
)
from src.pp.pipelines.table_recognition.table_recognition_post_processing_v2 import get_table_recognition_res
from src.pp.pipelines.table_recognition.utils import get_neighbor_boxes_idx
